...
def generate(args):
    ...
    if info.get("CFBundleIdentifier") != "suku.ViewTheWord":
        raise ValueError("The archive must contain ViewTheWord.")
    ...
    with tempfile.TemporaryDirectory(prefix="ViewTheWordFeed-") as directory:
